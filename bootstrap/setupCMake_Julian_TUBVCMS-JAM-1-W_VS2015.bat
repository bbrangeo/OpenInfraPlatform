...
"C:\Program Files (x86)\CMake\bin\cmake.exe" -G"Visual Studio 14 2015 Win64" -HC:\dev\OpenInfraPlatform -BC:\build\vs2015\OpenInfraPlatform ^
...
-DBLUEFRAMEWORK_ROOT_DIR="C:\dev\BlueFramework2"
