...
class OpenInfraPlatform::Infrastructure::OkstraExport::OkstraExportImpl : public Export
{
public:
...
OpenInfraPlatform::Infrastructure::OkstraExport::OkstraExport(int majorVersion, int minorVersion, buw::ReferenceCounted<buw::AlignmentModel> am, buw::ReferenceCounted<buw::DigitalElevationModel> dem, const std::string& filename) :
Export(am, dem, filename),
