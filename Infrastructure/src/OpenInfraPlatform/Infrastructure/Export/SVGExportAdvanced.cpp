...
#include "SVGExportAdvanced.h"

void OpenInfraPlatform::Infrastructure::SVGExportAdvanced::outputToSVG(FILE *fp, buw::ReferenceCounted<buw::HorizontalAlignment2D> horizontalAlignment)
{
	std::string output = "";
	buw::vector2d start;
...
void OpenInfraPlatform::Infrastructure::SVGExportAdvanced::addPath(FILE *fp, const buw::vector2d& a, const buw::vector2d& b, const buw::vector2d& c)
{
	fprintf(fp, "<path d=\"M %f,%f L %f,%f L %f,%f z\"/>\n", a.x(), -a.y(), b.x(), -b.y(), c.x(), -c.y());
}

OpenInfraPlatform::Infrastructure::SVGExportAdvanced::SVGExportAdvanced(buw::ReferenceCounted<buw::AlignmentModel> am, buw::ReferenceCounted<buw::DigitalElevationModel> dem, const std::string& filename) :
