...
namespace OpenInfraPlatform
{
	namespace IfcTunnel
	{
		// TYPE IfcTunnelSpaceEnum = ENUMERATION OF	(FULLTUNNELSPACE	,INTERIORSPACE	,ANNULARGAPSPACE	,LININGSPACE	,CLEARANCESPACE	,SERVICESPACE	,FLOORSPACE	,RING	,USERDEFINED	,NOTDEFINED);
