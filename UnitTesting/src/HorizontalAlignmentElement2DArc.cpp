...
namespace
{
	TEST(HorizontalAlignmentElement2DArc, getPosition)
	{
		...
		HorizontalAlignmentElement2DArc::Ptr arc = std::make_shared<HorizontalAlignmentElement2DArc>(center, start, end_, cw);
		HorizontalAlignment2D::Ptr ha = std::make_shared<HorizontalAlignment2D>();
		ha->addElement(arc);
	...
	TEST(HorizontalAlignmentElement2DArc, getLength3)
	{
		...
		HorizontalAlignmentElement2DArc::Ptr arc2 = std::make_shared<HorizontalAlignmentElement2DArc>(center, start, end_, cw);
		HorizontalAlignment2D::Ptr ha2 = std::make_shared<HorizontalAlignment2D>();
		ha2->addElement(arc2);
