...
namespace
{
	TEST(HorizontalAlignmentElement2DArbitraryCurve, getPosition)
	{
		...
		HorizontalAlignmentElement2DArbitraryCurve::Ptr a = std::make_shared<HorizontalAlignmentElement2DArbitraryCurve>(
			start,
			end,
			pi,
			length,
	...
	TEST(HorizontalAlignmentElement2DArbitraryCurve, getPosition2)
	{
		...
		buw::HorizontalAlignmentElement2DArbitraryCurve::Ptr a = std::make_shared<buw::HorizontalAlignmentElement2DArbitraryCurve>(
			start,
			end,
			pi,
			length,
